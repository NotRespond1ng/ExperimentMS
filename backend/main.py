...
# 导入路由
from routers import batches, persons, experiments, competitor_files, finger_blood_data, sensors, auth, activities, stats, sensor_details, wear_records, experiment_data
...
app.add_middleware(
    CORSMiddleware,
    # "http://192.168.10.14", "http://192.168.10.14:5173", "http://localhost:5173",
